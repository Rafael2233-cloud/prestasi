...
// Base query
$query = "SELECT * FROM poin_config WHERE 1=1";

if ($search !== '') {
    $query .= " AND (tingkat LIKE '%" . $conn->real_escape_string($search) . "%' OR juara LIKE '%" . $conn->real_escape_string($search) . "%')";
}

$query .= " ORDER BY poin DESC";
...
<head>
    ...
    <title>Cek Tentang Poin - SIPRESMA</title>
...
<body class="dashboard-body new-dashboard">
    ...
    <main class="main-content-new" id="mainContent">
        ...
        <div class="content-wrapper-new">
                ...
                <div class="page-header-flex">
                    <div class="page-title-new">
                        <div class="page-header-text">
                            <h1 style="margin: 0 0 5px 0; font-size: 24px; font-weight: 800; color: #0f172a;">Cek Tentang Poin</h1>
                            <p style="font-family: 'Inter', sans-serif; font-size: 13px; font-weight: 400; color: #64748b; line-height: 1.5; margin: 0;">Melihat standar nilai poin berdasarkan tingkat kompetisi dan juara.</p>
                        </div>
                    </div>
                    <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 15px;">
                        <div class="breadcrumb-top" style="margin-bottom: 0; font-size: 13px; color: #64748b;">
                            <a href="Dashboard.php" style="color: #2563eb; text-decoration: none;">Beranda</a> <span>/</span> Cek Tentang Poin
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Filter Section -->
            <form action="CekPoin.php" method="GET" id="filterForm">
                <div class="filter-card">
                    ...
                    <div class="filter-controls">
                        <div class="filter-group">
                            <label class="filter-label">Cari Tingkat/Juara</label>
                        ...
                        <a href="CekPoin.php" class="btn-reset"><i class="fa-solid fa-rotate-right"></i> Reset</a>
                    </div>
                </div>
            </form>
                    ...
                    <table class="custom-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-highlight"><?= htmlspecialchars($row['juara']) ?></td>
                                <td class="col-points"><?= ($row['poin'] ?? 0) ?></td>
                            </tr>
                            <?php endforeach; ?>
                            <?php if(count($poin_data) == 0): ?>
                            <tr>
                                <td colspan="4" style="text-align: center; padding: 30px; color: #64748b;">Tidak ada data yang tersedia.</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
