...
$query = "
    ...
    FROM mahasiswa m
    LEFT JOIN prestasi p ON m.id = p.mahasiswa_id AND p.status = 'approved'
    WHERE 1=1
";
...
$query .= " GROUP BY m.id, m.nim, m.nama, m.prodi, m.angkatan HAVING total_prestasi > 0 ORDER BY total_poin DESC, m.nama ASC";
...
<head>
    ...
    <title>Laporan per Mahasiswa - SIPRESMA</title>
...
<body class="dashboard-body new-dashboard">
    ...
    <main class="main-content-new" id="mainContent">
        ...
        <div class="content-wrapper-new">
                ...
                <div class="page-header-flex">
                    <div class="page-title-new">
                        <div class="page-header-text">
                            <h1 style="margin: 0 0 5px 0; font-size: 24px; font-weight: 800; color: #0f172a;">Laporan per Mahasiswa</h1>
                            <p style="font-family: 'Inter', sans-serif; font-size: 13px; font-weight: 400; color: #64748b; line-height: 1.5; margin: 0;">Rekapitulasi total prestasi dan total poin yang diraih oleh masing-masing mahasiswa.</p>
                        </div>
                    </div>
                    <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 15px;">
                        <div class="breadcrumb-top" style="margin-bottom: 0; font-size: 13px; color: #64748b;">
                            <a href="Dashboard.php" style="color: #2563eb; text-decoration: none;">Beranda</a> <span>/</span> Laporan per Mahasiswa
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Filter Section -->
            <form action="LaporanPerMahasiswa.php" method="GET" id="filterForm">
                <div class="filter-card">
                    ...
                    <div class="filter-controls">
                        <div class="filter-group">
                            <label class="filter-label">Cari Nama/NIM Mahasiswa</label>
                            <input type="text" class="filter-input" name="search" value="<?= htmlspecialchars($search) ?>" placeholder="Masukkan nama atau NIM...">
                        </div>
                        <button type="submit" class="btn-search"><i class="fa-solid fa-magnifying-glass"></i> Cari</button>
                        <a href="LaporanPerMahasiswa.php" class="btn-reset"><i class="fa-solid fa-rotate-right"></i> Reset</a>
                    </div>
                </div>
            </form>
                ...
                <div class="table-responsive">
                    <table class="custom-table">
                        ...
                        <tbody>
                            ...
                            <?php endforeach; ?>
                            <?php if(count($mahasiswa_data) == 0): ?>
                            <tr>
                                <td colspan="6" style="text-align: center; padding: 30px; color: #64748b;">Tidak ada data yang tersedia.</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
