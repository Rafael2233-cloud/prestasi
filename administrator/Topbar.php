...
<header class="topbar-new" style="display: flex; justify-content: space-between; align-items: center;">
    <button class="toggle-btn-new topbar-toggle-btn" onclick="document.getElementById('sidebar').classList.toggle('collapsed');">
    ...
    <div class="topbar-right" style="display: flex; align-items: center; gap: 20px; margin-left: auto;">
        <div class="notification-btn" onclick="document.getElementById('notifDropdown').classList.toggle('show'); document.getElementById('profileDropdown').classList.remove('show'); event.stopPropagation();" style="position: relative; cursor: pointer; color: #64748b; font-size: 20px; text-decoration: none;">
            <i class="fa-regular fa-bell" style="pointer-events: none;"></i>
            <?php if ($total_notif > 0): ?>
                <span class="badge" style="position: absolute; top: -5px; right: -8px; background: #ef4444; color: white; border-radius: 50%; padding: 2px 6px; font-size: 10px; font-weight: bold; pointer-events: none;"><?= $total_notif ?></span>
            <?php endif; ?>

            <div class="dropdown-menu" id="notifDropdown" onclick="event.stopPropagation();" style="width: 280px; left: auto; right: -10px; top: 130%; z-index: 1000; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); cursor: default;">
        ...
        <div class="user-profile-top" onclick="document.getElementById('profileDropdown').classList.toggle('show'); document.getElementById('notifDropdown').classList.remove('show'); event.stopPropagation();" style="position: relative; cursor: pointer; display: flex; align-items: center; gap: 10px;">
            <div class="avatar" style="background-color: #3b82f6; color: white; width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 15px; pointer-events: none;">F</div>
