...
// Get Admin Data
$q_admin = $conn->query("SELECT username, email FROM admin LIMIT 1");
$admin_data = $q_admin->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Biodata - Admin Portal</title>
    <!-- Modern font -->
    ...
    <aside class="sidebar-new" id="sidebar">
        ...
        <div class="sidebar-menus-container">
            ...
            <ul class="sidebar-menu-new">
                ...
                <li class="menu-item-new active"><a href="Biodata.php"><i class="fa-regular fa-user"></i> <span class="menu-text">Biodata</span></a></li>
            </ul>
        ...
        <div class="content-wrapper-new">
            ...
            <div class="profile-container">
                ...
                <div class="profile-left">
                    <div class="profile-avatar"><?= substr(htmlspecialchars($_SESSION['admin_nama'] ?? 'Admin'), 0, 1) ?></div>
                    ...
                    <ul class="profile-stats-list">
                        ...
                        <li>
                            <span class="stat-label"><i class="fa-regular fa-calendar"></i> Bergabung Sejak</span>
                            <span class="stat-value">22 Mei 2026</span>
                        </li>
                        <li>
                    ...
                    <ul class="info-list">
                        <li class="info-item">
                            ...
                            <div class="info-value">
                                <span class="info-value-text"><?= htmlspecialchars($_SESSION['admin_nip'] ?? '-') ?></span>
                                <input type="text" class="edit-input" value="<?= htmlspecialchars($_SESSION['admin_nip'] ?? '') ?>" id="editNip">
                            </div>
                        </li>
                        <li class="info-item">
                            ...
                            <div class="info-value">
                                <span class="info-value-text"><?= htmlspecialchars($_SESSION['admin_nama'] ?? 'Admin') ?></span>
                                <input type="text" class="edit-input" value="<?= htmlspecialchars($_SESSION['admin_nama'] ?? '') ?>" id="editNama">
                            </div>
                        </li>
                        <li class="info-item">
                            ...
                            <div class="info-value">
                                <span class="info-value-text"><?= htmlspecialchars($admin_data['username'] ?? '-') ?></span>
                                <input type="text" class="edit-input" value="<?= htmlspecialchars($admin_data['username'] ?? '') ?>" id="editUsername">
                            </div>
                        </li>
                        <li class="info-item">
                            ...
                            <div class="info-value">
                                <span class="info-value-text"><?= htmlspecialchars($admin_data['email'] ?? '-') ?></span>
                                <input type="email" class="edit-input" value="<?= htmlspecialchars($admin_data['email'] ?? '') ?>" id="editEmail">
                            </div>
                        </li>
                        <li class="info-item">
                            ...
                            <div class="info-value">
                                <ul style="margin: 0; padding-left: 20px; color: #1e293b; font-size: 13px; line-height: 1.6;">
                                    ...
                                    <li>Kelola Info Beasiswa</li>
                                    <li>Kelola Data Mahasiswa</li>
                                    <li>Kelola Kriteria Poin</li>
                        ...
                        <li class="info-item">
                            ...
                            <div class="info-value">
                                <span class="info-value-text">Admin Prestasi Mahasiswa</span>
                            </div>
                        </li>
                    </ul>
