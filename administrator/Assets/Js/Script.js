document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    /* 
    ===============================================
        Dashboard Page (Dashboard.php) Interactions
    =============================================== 
    */
    const toggleSidebarBtn = document.getElementById('toggleSidebar');
    const toggleSidebarTopbarBtn = document.getElementById('toggleSidebarTopbar');
    ...
    if (toggleSidebarBtn && sidebar) {
        toggleSidebarBtn.addEventListener('click', toggleSidebarFn);
    }
    if (toggleSidebarTopbarBtn && sidebar) {
        toggleSidebarTopbarBtn.addEventListener('click', toggleSidebarFn);
    }
